 ...
 */
long long int genomeFunctions::countGenomeLength(ifstream &input_file_pointer)
{
 ...
 * @param input_file_pointer Reference to the input file stream.
 */
void genomeFunctions::readGenomeData(ifstream &input_file_pointer)
{
    try
    {
        if (input_file_pointer.is_open())
        {
            ...
            long long int size = genomeFunctions::countGenomeLength(input_file_pointer);
 ...
 * @param input_file_pointer Reference to the input file stream.
 */
void genomeFunctions::computeCharacters(ifstream &input_file_pointer)
{
    try
    {
        if (input_file_pointer.is_open())
