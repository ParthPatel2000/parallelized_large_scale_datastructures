 ...
 */
void genomeProcessor::setSize(long long int size)
{
    genome_size = size;
}
 ...
 */
long long int genomeProcessor::getSize()
{
    return genome_size;
}
 ...
 */
char *genomeProcessor::getGenomeData()
{
    return genome_data;
}
 ...
 */
long long int genomeProcessor::countGenomeLength(ifstream &input_file_pointer)
{
 ...
 * @param input_file_pointer Reference to the input file stream.
 */
void genomeProcessor::readGenomeData(ifstream &input_file_pointer)
{
    try
    {
        if (input_file_pointer.is_open())
        {
            ...
            long long int size = genomeProcessor::countGenomeLength(input_file_pointer);
            input_file_pointer.clear();
            input_file_pointer.seekg(0, ios::beg);

            genome_data = new char[size + 1];
            genomeProcessor::setSize(size);
 ...
 * @param input_file_pointer Reference to the input file stream.
 */
void genomeProcessor::computeCharacters(ifstream &input_file_pointer)
{
    try
    {
        if (input_file_pointer.is_open())
